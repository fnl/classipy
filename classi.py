...
generate.add_argument("--cutoff", '-c', default=1, metaver='C', type=int, help="drop features below min. document frequency C; value must be a positive integer (default: keep all features)")
...
select.add_argument("--cutoff", '-c', default=1, metaver='C', type=int, help="drop features below min. document frequency C; value must be a positive integer (default: keep all features)")
