...
generate.add_argument("--binarize", action='store_true', help='combine the indpendent features as binary pairs')
...
generate.add_argument("--cutoff", '-c', default=1, type=int, help="drop features below a min. document frequency; value must be a positive integer (default=%(default)s - only use features seen at least in %(default)s documents)")
generate.add_argument("--select", '-s', default=0, metavar='K', type=int, help="select the K best features using a chi-square test; value must be a positive integer (default: keep all features)")
...
select.add_argument("--cutoff", '-c', default=1, type=int, help="drop features below a min. document frequency; value must be a positive integer (default: keep all features)")
...
predict_text.add_argument("--binarize", action='store_true', help='combine the indpendent features as binary pairs')
