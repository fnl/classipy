...
generate.add_argument('-i', '--index', metavar='INDEX', required=True, help="file to write the generated inverted index to")
...
evaluate.add_argument('-x', "--folds", metavar='N', default=5, type=int, help="do N-fold cross-validation for internal evaluations; " "N must be an integer > 1; defaults to 5")
