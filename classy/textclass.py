"""
.. py:module:: classy.text
   :synopsis: Tools for developing text classifiers.
...
def sub_all(patterns, mask, lines):
        ...
        try:
            if columns is None:
                ...
                if patterns and mask:
                    ...
                    for lines in inputs:
                        ...
                        jobs = joblib.Parallel(n_jobs=splits)(
                            delayed(sub_all)(patterns, mask, lines) for lines in jobs
                        )
                ...
                for f in files:
                    ...
                    data = [(sid, as_dict(s, ngrams)) for sid, s in sentences]
